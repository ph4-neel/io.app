...
Route::post('/User_Login',[UserController::class,'User_Login_view']) ->name('User_Login') -> middleware();
...
Route::get('/Profile',[RouteController::class,'Profile_Auth'])->name('Profile');
