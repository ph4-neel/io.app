 ...
 <script>
  ...
  <body>
    ...
    toastr.options.closeButton = true;
            ...
            <form method="POST" action="https://interviewo.app/admin/master/skills/1" accept-charset="UTF-8" enctype="multipart/form-data"><input name="_method" type="hidden" value="PUT"><input name="_token" type="hidden" value="FdOlP5Onyo0dR4DBNveCNOhs6L4hvGH7MB0PVQjj">
    ...
    <div class="col-auto d-flex align-items-center">
        <button type="submit" class="btn btn-sm btn-falcon-default me-2 d-none d-md-block"><span class="fas fa-save me-2"></span>Save Skill</button>
    </div>
</div>
        ...
        <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group has-validation">
                                <input class="form-control" placeholder="eg:Key Skills" name="title" type="text" value="Stress Management" id="title">
                                                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group has-validation">
                                <div class="radio">
                                    <label><input checked="checked" name="type" type="radio" value="soft" id="type"> Soft</label> 
                                    <label><input name="type" type="radio" value="hard" id="type"> Hard</label> 
                                    <label><input name="type" type="radio" value="tool" id="type"> Tool</label> 
                                    <label><input name="type" type="radio" value="tech" id="type"> Tech</label> 
                                    <label><input name="type" type="radio" value="domain" id="type"> Domain</label> 
                                    <label><input name="type" type="radio" value="key" id="type"> Key</label> 
                                </div>
                                                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Instructions" name="benefits" cols="50" rows="10" id="benefits">&lt;div class=&quot;row&quot;&gt;
            &lt;div class=&quot;col-md-6&quot;&gt;
              &lt;ul class=&quot;list-styled&quot;&gt;
                &lt;li&gt;Reduced symptoms of poor mental and physical health.&lt;/li&gt;
	&lt;li&gt;Fewer injuries, less illness and lost time.&lt;/li&gt;
	&lt;li&gt;Reduced sick leave usage, absences, and staff turnover.&lt;/li&gt;
	&lt;li&gt;Increased productivity.&lt;/li&gt;
	&lt;li&gt;Greater job satisfaction.&lt;/li&gt;
	&lt;li&gt;Increased work engagement.&lt;/li&gt;
	&lt;li&gt;Reduced costs to the employer.&lt;/li&gt;
              &lt;/ul&gt;
            &lt;/div&gt;
            &lt;div class=&quot;col-md-6&quot;&gt;
              &lt;ul class=&quot;list-styled&quot;&gt;
          ...
          &lt;/div&gt;</textarea>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Instructions" name="description" cols="50" rows="10" id="description">&lt;p&gt;&lt;strong&gt;Habits that may help include:&lt;/strong&gt;&lt;/p&gt;

&lt;ul&gt;
	&lt;li&gt;Exercise regularly.&lt;/li&gt;
	&lt;li&gt;Get out in the sunlight.&lt;/li&gt;
	&lt;li&gt;Drink less alcohol and caffeine close to bedtime.&lt;/li&gt;
	&lt;li&gt;Set a sleep schedule.&lt;/li&gt;
	&lt;li&gt;Don&#39;t look at your electronics 30-60 minutes before bed.&lt;/li&gt;
	&lt;li&gt;Try meditation or other forms of relaxation at bedtime.&lt;/li&gt;
&lt;/ul&gt;</textarea>
                        </div>
                    </div>
                </div>
    ...
    <div class="row gx-0 kanban-header rounded-2 px-card py-2 mt-2 mb-3">
    <div class="col d-flex align-items-center">
        <h5 class="mb-0">Skill FAQ</h5>
    </div>
    <div class="col-auto d-flex align-items-center">
        <a href="https://interviewo.app/admin/master/skill-faq/1" class="btn btn-sm btn-falcon-default me-2 d-none d-md-block"><span class="fas fa-plus me-2"></span>Create Skill FAQ</a>
    </div>
</div>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="card h-md-100">
    <div class="card-header pb-0">
        <h6 class="mb-0 mt-2 d-flex align-items-center">Skills FAQ</h6>
    </div>
    <div class="card-body d-flex flex-column justify-content-end">
...
<script src="https://interviewo.app/assets/js/theme.js"></script>
    ...
    <script src="https://interviewo.app/assets/ckeditor/ckeditor.js"></script>
<script>
