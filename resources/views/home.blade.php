                ...
                <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="../index.html"><span
                                    class="d-none d-lg-inline-block" data-bs-toggle="tooltip"
                        ...
                        <li class="nav-item"><a class="nav-link" href="../app/social/feed.html"><span
                                    class="d-none d-lg-inline-block" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Feed"><span
                                        class="fas fa-list-alt"></span></span><span class="d-lg-none">Feed</span></a>
                        </li>
                                ...
                                <div class="card shadow-none navbar-card-login">
                                    <div class="card-body fs--1 p-4 fw-normal">
                                        <div class="row text-start justify-content-between align-items-center mb-2">
                                            ...
                                            <div class="col-auto">
                                                <p class="fs--1 text-600 mb-0">or <a
                                                        href="../pages/authentication/simple/register.html">Create an
                                                        account</a></p>
                                            </div>
                                        </div>
                                        <form>
                                                ...
                                                <div class="col-auto">
                                                    <div class="form-check mb-0">
                                                        ...
                                                        <label class="form-check-label mb-0"
                                                            for="modal-checkbox">Remember me</label>
                                                    </div>
                                                </div>
