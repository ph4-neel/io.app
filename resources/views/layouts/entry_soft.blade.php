...
<body background="{{ asset('images/back2.jpg') }}">
    ...
    <nav class="navbar navbar-expand-lg bg-success" style="padding: 100px; height:70px">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"  style="color:aliceblue">Action</a></li>
                            <li><a class="dropdown-item" href="#"  style="color:aliceblue">Another action</a></li>
                            <li>
...
<br>
    ...
    <h2 style="text-align: center; margin-top:10px; color:white; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ">Soft Skills</h2>
    <h3 style="text-align: center; margin-top:10px; color:white; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif "> The most preferable and Demanding skills for All fields</h3>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="row g-3">
                        @foreach ($skills as $items)
                            <div class="col-md-4">
                                <div class="card shadow" style="padding: 65px"> <img src="{{ asset('images/background_page-0001.jpg') }}"
                                        class="card-img-top">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between"> <span
                                                class="font-weight-bold">{{ $items->title }}</span> <span
                                    ...
                                    <div class="card-body">
                                        <div class="text-center buttons">
                                            <a style="margin: auto" href="{{ url('get_data/' . $items->id) }}"
                                                class="btn btn-outline-dark">Know More</a>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="card"> <img src="https://i.imgur.com/hnQ492C.jpg" class="card-img-top">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between"> <span
                                            class="font-weight-bold">Dinning
                                            table set-4</span> <span class="font-weight-bold">$450</span> </div>
                        ...
                        <div class="col-md-4">
                            <div class="card"> <img src="https://i.imgur.com/10JlX4K.jpg" class="card-img-top">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between"> <span
                                            class="font-weight-bold">Dinning
                                            set set-8</span> <span class="font-weight-bold">$2,000</span> </div>
                                    <p class="card-text mb-1 mt-1">Some quick example text to build on the card title
                                        and make up the bulk of the card's content.</p>
                                    <div class="d-flex align-items-center flex-row"> <img
                                            src="https://i.imgur.com/e9VnSng.png" width="20"> <span
