                    ...
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav collapse show" id="e-commerce">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="../../app/e-commerce/customer-details.html" aria-expanded="false">
            ...
            <div class="content">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h5 class="mb-2">Tony Robbins (<a href="mailto:tony@gmail.com">tony@gmail.com</a>)</h5><a class="btn btn-falcon-default btn-sm" href="#!"><span class="fas fa-plus fs--2 me-1"></span>Add note</a>
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">Thank you for creating with interviewo <span class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> 2021 &copy; <a href="https://interviewo.app">interviewo</a></p>
                        </div>
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">io.app</p>
                        </div>
                    </div>
                </footer>
            </div>
