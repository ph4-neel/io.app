                                ...
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="../../../index.html">Interviewo</a>
                                            <p class="opacity-75 text-white">With the power of Interviewo, you can now focus only on functionaries for your digital products, while leaving the UI design on us!</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        <div class="row flex-between-center">
                                            <div class="col-auto">
                                                <h3>Institute Register</h3>
                                            </div>
                                        </div>
                                        <form>
                                        <div class="mb-3">
                                                <label class="form-label" for="card-name">Full Name</label>
                                                <input class="form-control" id="card-name" type="name" />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Name of Applicant</label>
                                                <input class="form-control" id="card-name" type="name" />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-job">Job Role</label>
                                                <input class="form-control" id="card-job" type="job" />
                                            </div>
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between">
                                                    <label class="form-label" for="card-website">Website</label>
                                                </div>
                                                <input class="form-control" id="card-website" type="website" />
                                            </div>
                                        ...
                                        <div class="row g-2 mt-2">
                                            <div class="col-sm-6"><a class="btn btn-outline-google-plus btn-sm d-block w-100" href="#"><span class="fab fa-google-plus me-1" data-fa-transform="grow-8"></span> Google</a></div>
                                            <div class="col-sm-6"><a class="btn btn-outline-facebook -square btn-sm d-block w-100" href="#"><span class="fab fa-facebook-square me-1" data-fa-transform="grow-8"></span> Facebook</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
