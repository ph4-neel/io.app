        ...
        <div class="container" data-layout="container">
          ...
          if (isFluid) {
            ...
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="https://interviewo.app/images/own-images/skills/tech/OCaml-289.jpg" alt="" width="40" /><span class="font-sans-serif">interviewo</span>
              </div>
            </a>
          </div> --}}
            ...
            {{-- <!-- more inner pages-->
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../app/e-commerce/product/product-grid.html" aria-expanded="false">
            ...
            {{-- <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-code-branch"></span></span><span class="nav-link-text ps-1"></span>
                    </div> --}}
            {{-- </a>
            </li>
            </ul> --}}
