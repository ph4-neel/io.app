        ...
        <div class="container" data-layout="container">
            ...
            <div class="d-flex align-items-center">
                <div class="toggle-icon-wrapper">
                    ...
                    <div class="d-flex align-items-center py-3"><img class="me-2" src="file:///C:/xampp/htdocs/falcon-3.4.0/Falcon-v3.4.0-and-v2.8.2/falcon-v3.4.0/public/assets/img/team/2.jpg" alt="" width="40" /><span class="font-sans-serif">interviewo</span>
                    </div>
                </a>
            </div>
                ...
                <div class="navbar-vertical-content scrollbar">
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav collapse show" id="user">
                                <li class="nav-item"><a class="nav-link active" href="../../pages/user/profile.html" aria-expanded="false">
                    ...
                    <div class="settings mb-3">
                        <div class="card alert p-0 shadow-none" role="alert">
                            <div class="btn-close-interviewo-container">
                                <div class="btn-close-interview" aria-label="Close" data-bs-dismiss="alert"></div>
                            </div>
