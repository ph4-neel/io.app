    ...
    <main class="main" id="top">
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape" src="{{ asset('images/blog/bg-shape.png') }}" alt="" width="250"><img class="bg-auth-circle-shape-2" src="{{ asset('images/blog/shape-1.png') }}" alt="" width="150">
                    <div class="card overflow-hidden z-index-1">
                        <div class="card-body p-0">
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        <div class="bg-holder bg-auth-card-shape" style="background-image:{{ asset('images/blog/half-circle.png') }}/)">
                                        </div>
                                        <!--/.bg-holder-->
                                        ...
                                        <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="../../../index.html">interviewo</a>
                                            <p class="opacity-75 text-white">With the power of interviewo, you can now focus
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form method="POST" action="/User_Registers">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">User Name</label>
                                                <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Job title</label>
                                                <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Organization Name</label>
                                                <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" required />
                                            </div>


                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Work for</label>
                                                <select class="form-control" type="text" name="types" autocomplete="on" id="card-name" required>

                                                    <option value="instructor">Government</option>
                                                    <option value="institute">N.P Agency</option>

                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-email">Job function</label>
                                                <input class="form-control" type="email" name="email" autocomplete="on" id="card-email" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Phone number</label>
                                                <select>
                                                    <option value="instructor">+91</option>
                                                    <option value="institute">+1</option>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Company Size</label>
                                                <input class="form-control" type="text" name="phone" autocomplete="on" id="card-name" required />
                                            </div>
                                            ...
                                            <div class="row gx-2">
                                                <div class="mb-3 col-sm-6">
                                                    ...
                                                    <input class="form-control" type="text" name="country" autocomplete="on" id="card-password" required />
                                                </div>
                                                <div class="row gx-2">
                                                    <div class="mb-3 col-sm-6">
                                                        <label class="form-label" for="card-password">State</label>
                                                        <input class="form-control" type="text" name="country" autocomplete="on" id="card-password" required />
                                                    </div>
                                                    <div class="row gx-2">
                                                        <div class="mb-3 col-sm-6">
                                                            <label class="form-label" for="card-password">City</label>
                                                            <input class="form-control" type="text" name="country" autocomplete="on" id="card-password" required />
                                                        </div>
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-label" for="card-register-checkbox">I accept the <a href="#!">terms </a>and <a href="#!">privacy
                                                                    policy</a></label>
                                                        </div>
                                                        <div class="mb-3">
