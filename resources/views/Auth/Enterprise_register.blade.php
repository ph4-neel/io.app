                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form method="POST" action="/User_Registers">
                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">FullName</label>
                                                <input class="form-control" type="text" name="name"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">TeamName</label>
                                                <input class="form-control" type="text" name="username"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Mobile</label>
                                                <input class="form-control" type="text" name="phone"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-email">WorkEmail</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Organization Size</label>
                                                <input class="form-control" type="text" name="phone"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            ...
                                            <div class="row gx-2">
                                                ...
                                                <div class="row gx-2">
                                                <div class="mb-3 col-sm-6">
                                                    <label class="form-label" for="card-password">Headquarters Region</label>
                                                    <input class="form-control" type="text" name="country"
                                                        autocomplete="on" id="card-password" required />
                                                </div>
