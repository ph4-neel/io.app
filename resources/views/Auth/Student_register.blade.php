                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form method="POST" action="/User_Registers">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Email</label>
                                                <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Headline</label>
                                                <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" required />
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Position</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">College</label>
                                                <input class="form-control" type="text" name="phone" autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Course</label>
                                                <input class="form-control" type="text" name="phone" autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="row gx-2">
                                                <div class="mb-3 col-sm-6">
                                                    <label class="form-label" for="card-password">Education</label>
