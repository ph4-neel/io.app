                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form method="POST" action="/User_Registers">
                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Authority Name</label>
                                                <input class="form-control" type="text" name="name"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Institution Name</label>
                                                <input class="form-control" type="text" name="username"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Category</label>
                                                <select class="form-control" type="text" name="types"
                                                    autocomplete="on" id="card-name" required>
                                                    <option value="student">education</option>
                                                    <option value="instructor">Information technology</option>
                                                    <option value="institute">Computer science engineering</option>
                                                    <option value="enterPrices">Artificial intelligence and data science</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Mobile number</label>
                                                <input class="form-control" type="text" name="phone"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Best time for calling</label>
                                                <input class="form-control" type="text" name="phone"
                                                    autocomplete="on" id="card-name" required />
                                            </div>
