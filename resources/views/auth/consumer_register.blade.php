                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a
                                            ...
                                            <p class="opacity-75 text-white">With the power of Interviewo, you can now
                                                focus only on functionaries for your digital products, while leaving the
                                                UI design on us!</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="{{ route('consumer_register') }}" method="POST">
                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label" for="card-name">Full Name</label>
                                                <input class="form-control" id="card-name" name="name"
                                                    type="name" />
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="card-user">Email</label>
                                                <input class="form-control" id="card-user" name="email"
                                                    type="user" />
                                                @if ($errors->has('email'))
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="card-email" name="username" />
                                            ...
                                            <div class="row flex-between-center">
                                                ...
                                                <div class="col-auto"><a class="fs--1"
                                                        href="{{ url('/forgot') }}">Forgot Password?</a></div>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="row g-2 mt-2">
                                            <div class="col-sm-6"><a
                                                    ...
                                                    href="#"><span class="fab fa-google-plus me-1"
                                                        data-fa-transform="grow-8"></span> Google</a></div>
                                            <div class="col-sm-6"><a
                                                    class="btn btn-outline-facebook -square btn-sm d-block w-100"
                                                    href="#"><span class="fab fa-facebook-square me-1"
