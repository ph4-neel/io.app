            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2" src="https://interviewo.app/images/own-images/skills/tech/Javascript-667.jpg" alt="" width="40" /><span class="font-sans-serif">interviewo.app
                            </span>
                        </div>
                    </a>
                </div>
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse show" id="dashboard">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{ url('/consumers') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Consumers</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>

                                    <li class="nav-item"><a class="nav-link" href="{{ url('/soft_list') }}" aria-expanded="false">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{ url('/apis') }}" aria-expanded="false">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{ url('/data_entry') }}" aria-expanded="false">
